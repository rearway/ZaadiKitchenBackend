...
export const RevenuePersistenceS = Symbol('revenue-persistence')
export const CommsPersistenceS = Symbol('comms-persistence')
...
export const PaymentTransactionPersistenceS = Symbol('payment-transaction-persistence')
